...
export const metadata: Metadata = {
  ...
  description: "Descubre todas las funcionalidades de Mentor Salud: historial médico, perfil de salud, grupos de apoyo, material educativo y foros moderados.",
}
...
const mainFeatures = [
  {
    ...
    description: "Accede a tu historial médico completo en cualquier momento y desde cualquier lugar.",
    ...
    details: "Nuestro sistema de historial médico te permite tener un registro completo y organizado de toda tu información de salud. Desde tus primeras consultas hasta los tratamientos más recientes, todo está disponible de forma segura y accesible.",
  },
  {
    id: "perfil",
    icon: User,
    title: "Perfil de Salud",
    description: "Mantén actualizada tu información médica más importante para emergencias.",
    ...
    details: "Tu perfil de salud es tu carta de presentación médica. En caso de emergencia, los profesionales de salud pueden acceder rápidamente a la información crítica que necesitan para brindarte la mejor atención.",
  },
  {
    id: "grupos",
    icon: Users,
    ...
    details: "Los grupos de apoyo ofrecen un espacio seguro donde puedes compartir experiencias, aprender de otros y recibir apoyo emocional de personas que entienden por lo que estás pasando.",
  },
  {
    id: "educativo",
    icon: BookOpen,
    ...
    details: "El conocimiento es poder. Nuestro material educativo está diseñado para ayudarte a entender mejor tu salud y tomar decisiones informadas junto con tu médico.",
  },
  {
    id: "foros",
    icon: MessageSquare,
    ...
    details: "Nuestros foros son espacios de discusión donde puedes hacer preguntas, compartir conocimientos y recibir orientación de profesionales de la salud y otros usuarios.",
  },
]
...
const additionalFeatures = [
  {
    ...
    description: "Agenda, reprograma y recibe recordatorios de tus citas médicas.",
  },
  {
    icon: Pill,
    title: "Recetas Digitales",
    description: "Accede a tus recetas y recordatorios de medicamentos en cualquier momento.",
  },
  {
    icon: Heart,
    title: "Seguimiento de Salud",
    description: "Monitorea tus signos vitales y condiciones crónicas de forma continua.",
  },
  {
    icon: Activity,
      ...
      <section className="pt-32 pb-16 lg:pt-40 lg:pb-24 bg-gradient-to-b from-primary/5 to-background">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm font-medium text-primary mb-4">Funcionalidades</p>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-foreground text-balance">
              Herramientas diseñadas para tu bienestar
            </h1>
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              Descubre todas las funcionalidades que Mentor Salud pone a tu disposición para mejorar la gestión de tu salud.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className={`grid lg:grid-cols-2 gap-12 lg:gap-16 items-center ${index % 2 === 1 ? "lg:flex-row-reverse" : ""}`}>
              <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                ...
                <p className="mt-4 text-muted-foreground leading-relaxed">{feature.details}</p>
              ...
              <div className={`relative ${index % 2 === 1 ? "lg:order-1" : ""}`}>
                ...
                <div className="relative bg-card rounded-3xl border border-border p-8">
                  <h3 className="text-lg font-semibold text-foreground mb-6">Características principales</h3>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-primary-foreground/80">
              Únete a miles de usuarios que ya confían en Mentor Salud para gestionar su bienestar.
            </p>
